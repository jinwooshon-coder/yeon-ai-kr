...
window.YEON_CONFIG = {
  ...
  // ============================================
  // Google Apps Script 웹앱 배포 URL (README_회원관리.md 참고)
  // 빈 값이거나 PASTE_YOUR_URL_HERE 이면 localStorage 데모 모드로 동작합니다.
  APPS_SCRIPT_URL: 'https://script.google.com/macros/s/AKfycbxkMtmZDzxaDY9Wr7waquumLeFPkcnQrUtq4_7Us56ohUEt7fUslrlAs1LiYt9t0uK-/exec',

  // Apps Script 와 공유하는 시크릿 (Script Properties 의 APP_SECRET 와 같아야 함)
  ...
  // ============================================
  // 생태계 앱 — 본 앱과 함께 쓸 수 있는 연 프로젝트 시리즈
  // ============================================
  // parent.html / 가입 안내에서 "함께 쓰면 더 좋은 앱" 으로 노출.
  // 모든 앱은 동일한 계정/패킷/누적 데이터를 공유하도록 설계(향후 백엔드 연동).
  ECOSYSTEM_APPS: [
    {
      id: 'supul-ai',
      name: '수풀AI',
      desc: '현재 앱 · 수학 AI 풀이 도우미 · 3가지 풀이법 · 약점 누적 분석',
      status: 'live',
      current: true
    },
    {
      id: 'yeon-english',
      name: '영풀',
      desc: '영어 전용 AI 학습 · 저작권 회피 학년별 문장 DB',
      status: 'live'
    },
    {
      id: 'yeon-planner',
      name: '연플래너',
      desc: '학습 계획 · 복습 알림 · 매일 연속 학습 스트릭 관리',
      status: 'live'
    },
    {
      id: 'twenty-q',
      name: '스무고개 학습',
      desc: 'AI 20문답 추리 학습 · 영어 우선 출시 후 전과목',
      status: 'beta'
    },
    {
      id: 'vocab-notebook',
      name: '단어 학습장',
      desc: '즉시 저장 단어 · 원문 + 일기 예문 · 영작 훈련 연결',
      status: 'live'
    },
    {
      id: 'cumulative-report',
      name: '누적 분석 보고서',
      desc: '학생 취약점 정밀 분석 · 선생님/부모님 월간 리포트 자동 발송',
      status: 'live'
    }
  ],
